...
public static class GtkTextIterExtensions
{
	...
	{
		if (iter.IsInvalid || iter.IsClosed) throw new Exception("Invalid or closed handle (GtkTextIter)");
	...
	{
		if (lhs.IsInvalid || lhs.IsClosed) throw new Exception("Invalid or closed handle (GtkTextIter)");
	...
	{
		if (start.IsInvalid || start.IsClosed) throw new Exception("Invalid or closed handle (GtkTextIter)");
	...
	{
		if (first.IsInvalid || first.IsClosed) throw new Exception("Invalid or closed handle (GtkTextIter)");
