...
public static class GFileInfoHandleExtensions
{
	...
	{
		if (info.IsInvalid || info.IsClosed) throw new Exception("Invalid or closed handle (GFileInfoHandle)");
	...
	{
		if (src_info.IsInvalid || src_info.IsClosed) throw new Exception("Invalid or closed handle (GFileInfoHandle)");
	...
	{
		if (other.IsInvalid || other.IsClosed) throw new Exception("Invalid or closed handle (GFileInfoHandle)");
