...
public static class GtkIconInfoHandleExtensions
{
	...
	{
		return GtkIconInfoHandleExterns.gtk_icon_info_load_icon(icon_info);
	}
	...
	{
		return GtkIconInfoHandleExterns.gtk_icon_info_load_icon_finish(icon_info, res);
	}
	...
	{
		return GtkIconInfoHandleExterns.gtk_icon_info_load_surface(icon_info, for_window);
	}
	...
	{
		return GtkIconInfoHandleExterns.gtk_icon_info_load_symbolic(icon_info, fg, success_color, warning_color, error_color, out was_symbolic);
	}
	...
	{
		return GtkIconInfoHandleExterns.gtk_icon_info_load_symbolic_finish(icon_info, res, out was_symbolic);
	}
	...
	{
		return GtkIconInfoHandleExterns.gtk_icon_info_load_symbolic_for_context(icon_info, context, out was_symbolic);
	}
	...
	{
		return GtkIconInfoHandleExterns.gtk_icon_info_load_symbolic_for_context_finish(icon_info, res, out was_symbolic);
	}
	...
	{
		return GtkIconInfoHandleExterns.gtk_icon_info_load_symbolic_for_style(icon_info, style, state, out was_symbolic);
	}
...
internal class GtkIconInfoHandleExterns
{
	...
	[DllImport(GtkLibrary.Name)]
	internal static extern MentorLake.GdkPixbuf.GdkPixbufHandle gtk_icon_info_load_icon([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gtk.GtkIconInfoHandle>))] MentorLake.Gtk.GtkIconInfoHandle icon_info);
