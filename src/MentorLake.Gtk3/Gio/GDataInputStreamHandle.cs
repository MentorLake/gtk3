...
public static class GDataInputStreamHandleExtensions
{
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_byte(stream, cancellable);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_int16(stream, cancellable);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_int32(stream, cancellable);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_int64(stream, cancellable);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_line(stream, out length, cancellable);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_line_finish(stream, result, out length);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_line_finish_utf8(stream, result, out length);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_line_utf8(stream, out length, cancellable);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_uint16(stream, cancellable);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_uint32(stream, cancellable);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_uint64(stream, cancellable);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_until(stream, stop_chars, out length, cancellable);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_until_finish(stream, result, out length);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_upto(stream, stop_chars, stop_chars_len, out length, cancellable);
	}
	...
	{
		return GDataInputStreamHandleExterns.g_data_input_stream_read_upto_finish(stream, result, out length);
	}
...
internal class GDataInputStreamHandleExterns
{
	...
	[DllImport(GioLibrary.Name)]
	internal static extern byte[] g_data_input_stream_read_line_finish([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GDataInputStreamHandle>))] MentorLake.Gio.GDataInputStreamHandle stream, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GAsyncResultHandleImpl>))] MentorLake.Gio.GAsyncResultHandle result, out UIntPtr length);
