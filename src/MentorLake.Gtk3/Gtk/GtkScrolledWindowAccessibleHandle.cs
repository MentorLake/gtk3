...
public static class GtkScrolledWindowAccessibleHandleSignalExtensions
{
/// <summary>
/// <para>
...
/// </summary>
	...
	public static IObservable<GtkScrolledWindowAccessibleHandleSignalStructs.BoundsChangedSignal> Signal_BoundsChanged(this GtkScrolledWindowAccessibleHandle instance, GConnectFlags connectFlags = GConnectFlags.G_CONNECT_AFTER)
	{
		return Observable.Create((IObserver<GtkScrolledWindowAccessibleHandleSignalStructs.BoundsChangedSignal> obs) =>
		{
			GtkScrolledWindowAccessibleHandleSignalDelegates.bounds_changed handler = ( MentorLake.Atk.AtkComponentHandle self,  MentorLake.Atk.AtkRectangleHandle arg1,  IntPtr user_data) =>
			{
				

				var signalStruct = new GtkScrolledWindowAccessibleHandleSignalStructs.BoundsChangedSignal()
				{
...
public static class GtkScrolledWindowAccessibleHandleSignalStructs
{
...
public static class GtkScrolledWindowAccessibleHandleSignalDelegates
{
