...
public static class GtkContainerAccessibleHandleSignalExtensions
{
	...
	{
		return Observable.Create((IObserver<GtkContainerAccessibleHandleSignalStructs.BoundsChangedSignal> obs) =>
		{
			GtkContainerAccessibleHandleSignalDelegates.bounds_changed handler = ( MentorLake.Atk.AtkComponentHandle self,  MentorLake.Atk.AtkRectangleHandle arg1,  IntPtr user_data) =>
			{
				

				var signalStruct = new GtkContainerAccessibleHandleSignalStructs.BoundsChangedSignal()
				{
...
public static class GtkContainerAccessibleHandleSignalStructs
{
...
public static class GtkContainerAccessibleHandleExtensions
{
}

internal class GtkContainerAccessibleHandleExterns
{
}
