...
public static class GtkTextIterHandleExtensions
{
	...
	public static bool BeginsTag(this GtkTextIterHandle iter, GtkTextTagHandle tag)
	{
	...
	public static bool GetAttributes(this GtkTextIterHandle iter, out GtkTextAttributes values)
	{
	...
	public static GdkPixbufHandle GetPixbuf(this GtkTextIterHandle iter)
	{
...
internal class GtkTextIterExterns
{
	...
	[DllImport(Libraries.Gtk3)]
	internal static extern bool gtk_text_iter_begins_tag(GtkTextIterHandle iter, GtkTextTagHandle tag);
	...
	[DllImport(Libraries.Gtk3)]
	internal static extern bool gtk_text_iter_get_attributes(GtkTextIterHandle iter, out GtkTextAttributes values);
	...
	[DllImport(Libraries.Gtk3)]
	internal static extern GdkPixbufHandle gtk_text_iter_get_pixbuf(GtkTextIterHandle iter);
