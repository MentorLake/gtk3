...
public static class GFileIOStreamHandleExtensions
{
	...
	{
		return GFileIOStreamHandleExterns.g_file_io_stream_query_info(stream, attributes, cancellable);
	}
	...
	{
		return GFileIOStreamHandleExterns.g_file_io_stream_query_info_finish(stream, result);
	}
