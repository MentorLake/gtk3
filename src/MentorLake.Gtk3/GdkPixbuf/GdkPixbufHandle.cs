...
public static class GdkPixbufHandleExtensions
{
	...
	{
		if (pixbuf.IsInvalid || pixbuf.IsClosed) throw new Exception("Invalid or closed handle (GdkPixbufHandle)");
	...
	{
		if (src.IsInvalid || src.IsClosed) throw new Exception("Invalid or closed handle (GdkPixbufHandle)");
	...
	{
		if (src_pixbuf.IsInvalid || src_pixbuf.IsClosed) throw new Exception("Invalid or closed handle (GdkPixbufHandle)");
