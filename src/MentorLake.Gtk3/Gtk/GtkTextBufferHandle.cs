...
public static class GtkTextBufferHandleExtensions
{
	...
	{
		return GtkTextBufferHandleExterns.gtk_text_buffer_deserialize(register_buffer, content_buffer, format, iter, data, length);
	}
