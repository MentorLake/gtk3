...
public static class GDataOutputStreamHandleExtensions
{
	...
	{
		return GDataOutputStreamHandleExterns.g_data_output_stream_put_byte(stream, data, cancellable);
	}
	...
	{
		return GDataOutputStreamHandleExterns.g_data_output_stream_put_int16(stream, data, cancellable);
	}
	...
	{
		return GDataOutputStreamHandleExterns.g_data_output_stream_put_int32(stream, data, cancellable);
	}
	...
	{
		return GDataOutputStreamHandleExterns.g_data_output_stream_put_int64(stream, data, cancellable);
	}
	...
	{
		return GDataOutputStreamHandleExterns.g_data_output_stream_put_string(stream, str, cancellable);
	}
	...
	{
		return GDataOutputStreamHandleExterns.g_data_output_stream_put_uint16(stream, data, cancellable);
	}
	...
	{
		return GDataOutputStreamHandleExterns.g_data_output_stream_put_uint32(stream, data, cancellable);
	}
	...
	{
		return GDataOutputStreamHandleExterns.g_data_output_stream_put_uint64(stream, data, cancellable);
	}
