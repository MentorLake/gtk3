...
public static class GtkImageAccessibleHandleSignalExtensions
{
/// <summary>
/// <para>
...
/// </summary>
	...
	public static IObservable<GtkImageAccessibleHandleSignalStructs.BoundsChangedSignal> Signal_BoundsChanged(this GtkImageAccessibleHandle instance, GConnectFlags connectFlags = GConnectFlags.G_CONNECT_AFTER)
	{
		return Observable.Create((IObserver<GtkImageAccessibleHandleSignalStructs.BoundsChangedSignal> obs) =>
		{
			GtkImageAccessibleHandleSignalDelegates.bounds_changed handler = ( MentorLake.Atk.AtkComponentHandle self,  MentorLake.Atk.AtkRectangleHandle arg1,  IntPtr user_data) =>
			{
				

				var signalStruct = new GtkImageAccessibleHandleSignalStructs.BoundsChangedSignal()
				{
...
public static class GtkImageAccessibleHandleSignalStructs
{
...
public static class GtkImageAccessibleHandleSignalDelegates
{
