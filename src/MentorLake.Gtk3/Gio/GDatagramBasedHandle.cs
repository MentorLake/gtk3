...
public static class GDatagramBasedHandleExtensions
{
	...
	{
		return GDatagramBasedHandleExterns.g_datagram_based_condition_wait(datagram_based, condition, timeout, cancellable);
	}
	...
	{
		return GDatagramBasedHandleExterns.g_datagram_based_receive_messages(datagram_based, messages, num_messages, flags, timeout, cancellable);
	}
	...
	{
		return GDatagramBasedHandleExterns.g_datagram_based_send_messages(datagram_based, messages, num_messages, flags, timeout, cancellable);
	}
