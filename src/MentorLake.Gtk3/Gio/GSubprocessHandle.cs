...
public static class GSubprocessHandleExtensions
{
	...
	{
		return GSubprocessHandleExterns.g_subprocess_communicate(subprocess, stdin_buf, cancellable, out stdout_buf, out stderr_buf);
	}
	...
	{
		return GSubprocessHandleExterns.g_subprocess_communicate_finish(subprocess, result, out stdout_buf, out stderr_buf);
	}
	...
	{
		return GSubprocessHandleExterns.g_subprocess_communicate_utf8(subprocess, stdin_buf, cancellable, out stdout_buf, out stderr_buf);
	}
	...
	{
		return GSubprocessHandleExterns.g_subprocess_communicate_utf8_finish(subprocess, result, out stdout_buf, out stderr_buf);
	}
	...
	{
		return GSubprocessHandleExterns.g_subprocess_wait(subprocess, cancellable);
	}
	...
	{
		return GSubprocessHandleExterns.g_subprocess_wait_check(subprocess, cancellable);
	}
	...
	{
		return GSubprocessHandleExterns.g_subprocess_wait_check_finish(subprocess, result);
	}

	public static bool WaitFinish(this MentorLake.Gio.GSubprocessHandle subprocess, MentorLake.Gio.GAsyncResultHandle result)
	{
		return GSubprocessHandleExterns.g_subprocess_wait_finish(subprocess, result);
	}
