...
public static class GTlsInteractionHandleExtensions
{
	...
	{
		return GTlsInteractionHandleExterns.g_tls_interaction_ask_password(interaction, password, cancellable);
	}
	...
	{
		return GTlsInteractionHandleExterns.g_tls_interaction_ask_password_finish(interaction, result);
	}
	...
	{
		return GTlsInteractionHandleExterns.g_tls_interaction_invoke_ask_password(interaction, password, cancellable);
	}
	...
	{
		return GTlsInteractionHandleExterns.g_tls_interaction_invoke_request_certificate(interaction, connection, flags, cancellable);
	}
	...
	{
		return GTlsInteractionHandleExterns.g_tls_interaction_request_certificate(interaction, connection, flags, cancellable);
	}
	...
	{
		return GTlsInteractionHandleExterns.g_tls_interaction_request_certificate_finish(interaction, result);
	}
