...
public static class GResourceExtensions
{
	...
	public static string[] EnumerateChildren(this MentorLake.Gio.GResourceHandle resource, string path, MentorLake.Gio.GResourceLookupFlags lookup_flags, IntPtr error)
	{
		return GResourceExterns.g_resource_enumerate_children(resource, path, lookup_flags, error);
	}

	public static bool GetInfo(this MentorLake.Gio.GResourceHandle resource, string path, MentorLake.Gio.GResourceLookupFlags lookup_flags, out UIntPtr size, out uint flags, IntPtr error)
	{
		return GResourceExterns.g_resource_get_info(resource, path, lookup_flags, out size, out flags, error);
	}
	...
	public static MentorLake.GLib.GBytesHandle LookupData(this MentorLake.Gio.GResourceHandle resource, string path, MentorLake.Gio.GResourceLookupFlags lookup_flags, IntPtr error)
	{
		return GResourceExterns.g_resource_lookup_data(resource, path, lookup_flags, error);
	}

	public static MentorLake.Gio.GInputStreamHandle OpenStream(this MentorLake.Gio.GResourceHandle resource, string path, MentorLake.Gio.GResourceLookupFlags lookup_flags, IntPtr error)
	{
		return GResourceExterns.g_resource_open_stream(resource, path, lookup_flags, error);
	}
...
internal class GResourceExterns
{
	...
	internal static extern string[] g_resource_enumerate_children([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GResourceHandle>))] MentorLake.Gio.GResourceHandle resource, string path, MentorLake.Gio.GResourceLookupFlags lookup_flags, IntPtr error);

	[DllImport(GioLibrary.Name)]
	internal static extern bool g_resource_get_info([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GResourceHandle>))] MentorLake.Gio.GResourceHandle resource, string path, MentorLake.Gio.GResourceLookupFlags lookup_flags, out UIntPtr size, out uint flags, IntPtr error);
	...
	[DllImport(GioLibrary.Name)]
	internal static extern MentorLake.GLib.GBytesHandle g_resource_lookup_data([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GResourceHandle>))] MentorLake.Gio.GResourceHandle resource, string path, MentorLake.Gio.GResourceLookupFlags lookup_flags, IntPtr error);
...
{
	public static MentorLake.Gio.GResourceHandle Load(string filename, IntPtr error)
	{
		return GResourceExterns.g_resource_load(filename, error);
	}
