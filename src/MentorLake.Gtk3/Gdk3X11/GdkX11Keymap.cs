...
{
	public static int GetGroupForState(this GdkX11KeymapHandle keymap, uint state)
	{
		return GdkX11KeymapExterns.gdk_x11_keymap_get_group_for_state(keymap, state);
	}

	public static bool KeyIsModifier(this GdkX11KeymapHandle keymap, uint keycode)
	{
