...
public static class GtkGestureHandleExtensions
{
	...
	public static GdkWindowHandle GetWindow(this GtkGestureHandle gesture)
	{
...
internal class GtkGestureExterns
{
	...
	[DllImport(Libraries.Gtk3)]
	internal static extern GdkWindowHandle gtk_gesture_get_window(GtkGestureHandle gesture);
	...
	[DllImport(Libraries.Gtk3)]
	internal static extern void gtk_gesture_set_window(GtkGestureHandle gesture, GdkWindowHandle window);
