...
public static class graphene_euler_tExtensions
{
	...
	{
		if (a.IsInvalid || a.IsClosed) throw new Exception("Invalid or closed handle (graphene_euler_t)");
	...
	{
		if (e.IsInvalid || e.IsClosed) throw new Exception("Invalid or closed handle (graphene_euler_t)");
