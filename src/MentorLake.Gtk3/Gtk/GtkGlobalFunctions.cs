...
public class GtkGlobalFunctions
{
	...
	{
		return GtkGlobalFunctionsExterns.gtk_init_with_args(ref argc, ref argv, parameter_string, entries, translation_domain);
	}
	...
	{
		return GtkGlobalFunctionsExterns.gtk_show_uri(screen, uri, timestamp);
	}

	public static bool ShowUriOnWindow(MentorLake.Gtk.GtkWindowHandle parent, string uri, uint timestamp)
	{
		return GtkGlobalFunctionsExterns.gtk_show_uri_on_window(parent, uri, timestamp);
	}
...
internal class GtkGlobalFunctionsExterns
{
	...
	[DllImport(GtkLibrary.Name)]
	internal static extern bool gtk_init_with_args(ref int argc, ref string[] argv, string parameter_string, MentorLake.GLib.GOptionEntry[] entries, string translation_domain);
	...
	[DllImport(GtkLibrary.Name)]
	internal static extern bool gtk_show_uri([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gdk.GdkScreenHandle>))] MentorLake.Gdk.GdkScreenHandle screen, string uri, uint timestamp);

	[DllImport(GtkLibrary.Name)]
	internal static extern bool gtk_show_uri_on_window([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gtk.GtkWindowHandle>))] MentorLake.Gtk.GtkWindowHandle parent, string uri, uint timestamp);
