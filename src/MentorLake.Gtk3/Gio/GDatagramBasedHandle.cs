...
public static class GDatagramBasedHandleExtensions
{
	...
	public static bool ConditionWait(this MentorLake.Gio.GDatagramBasedHandle datagram_based, MentorLake.GLib.GIOCondition condition, long timeout, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GDatagramBasedHandleExterns.g_datagram_based_condition_wait(datagram_based, condition, timeout, cancellable, error);
	}
	...
	public static int ReceiveMessages(this MentorLake.Gio.GDatagramBasedHandle datagram_based, MentorLake.Gio.GInputMessage[] messages, uint num_messages, int flags, long timeout, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GDatagramBasedHandleExterns.g_datagram_based_receive_messages(datagram_based, messages, num_messages, flags, timeout, cancellable, error);
	}

	public static int SendMessages(this MentorLake.Gio.GDatagramBasedHandle datagram_based, MentorLake.Gio.GOutputMessage[] messages, uint num_messages, int flags, long timeout, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GDatagramBasedHandleExterns.g_datagram_based_send_messages(datagram_based, messages, num_messages, flags, timeout, cancellable, error);
	}
