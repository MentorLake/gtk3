...
public static class GtkRecentInfoHandleExtensions
{
	...
	public static long GetAdded(this GtkRecentInfoHandle info)
	{
	...
	public static bool GetApplicationInfo(this GtkRecentInfoHandle info, string app_name, out string app_exec, out uint count, out long time_)
	{
	...
	public static GdkPixbufHandle GetIcon(this GtkRecentInfoHandle info, int size)
	{
	...
	public static long GetModified(this GtkRecentInfoHandle info)
	{
	...
	public static long GetVisited(this GtkRecentInfoHandle info)
	{
...
internal class GtkRecentInfoExterns
{
	...
	[DllImport(Libraries.Gtk3)]
	internal static extern long gtk_recent_info_get_added(GtkRecentInfoHandle info);

	[DllImport(Libraries.Gtk3)]
	internal static extern int gtk_recent_info_get_age(GtkRecentInfoHandle info);

	[DllImport(Libraries.Gtk3)]
	internal static extern bool gtk_recent_info_get_application_info(GtkRecentInfoHandle info, string app_name, out string app_exec, out uint count, out long time_);
	...
	[DllImport(Libraries.Gtk3)]
	internal static extern GdkPixbufHandle gtk_recent_info_get_icon(GtkRecentInfoHandle info, int size);
	...
	[DllImport(Libraries.Gtk3)]
	internal static extern long gtk_recent_info_get_modified(GtkRecentInfoHandle info);
	...
	[DllImport(Libraries.Gtk3)]
	internal static extern long gtk_recent_info_get_visited(GtkRecentInfoHandle info);
