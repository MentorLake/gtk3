...
public static class GtkCellRendererAccelSignalExtensions
{
	...
	public static IObservable<GtkCellRendererAccelSignalStructs.AccelEditedSignal> Signal_AccelEdited(this GtkCellRendererAccelHandle instance)
	{
		...
		{
			GtkCellRendererAccelSignalDelegates.accel_edited handler = (GtkCellRendererAccelHandle self, string path_string, uint accel_key, ref GdkModifierType accel_mods, uint hardware_keycode, IntPtr user_data) =>
			{
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public delegate void accel_edited([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<GtkCellRendererAccelHandle>))] GtkCellRendererAccelHandle self, string path_string, uint accel_key, ref GdkModifierType accel_mods, uint hardware_keycode, IntPtr user_data);
