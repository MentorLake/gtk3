...
public static class GtkBooleanCellAccessibleHandleSignalExtensions
{

	public static IObservable<GtkBooleanCellAccessibleHandleSignalStructs.BoundsChangedSignal> Signal_BoundsChanged(this GtkBooleanCellAccessibleHandle instance, GConnectFlags connectFlags = GConnectFlags.G_CONNECT_AFTER)
	{
		return Observable.Create((IObserver<GtkBooleanCellAccessibleHandleSignalStructs.BoundsChangedSignal> obs) =>
		{
			GtkBooleanCellAccessibleHandleSignalDelegates.bounds_changed handler = ( MentorLake.Atk.AtkComponentHandle self,  MentorLake.Atk.AtkRectangleHandle arg1,  IntPtr user_data) =>
			{
				

				var signalStruct = new GtkBooleanCellAccessibleHandleSignalStructs.BoundsChangedSignal()
				{
...
public static class GtkBooleanCellAccessibleHandleSignalStructs
{
...
public static class GtkBooleanCellAccessibleHandleSignalDelegates
{
