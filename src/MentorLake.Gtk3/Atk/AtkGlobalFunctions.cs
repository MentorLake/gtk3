...
public class AtkGlobalFunctions
{
	...
	[DllImport(Libraries.Atk)]
	public static extern uint atk_add_focus_tracker(AtkEventListener focus_tracker);

	[DllImport(Libraries.Atk)]
	public static extern AtkRegistryHandle atk_get_default_registry();
	...
	[DllImport(Libraries.Atk)]
	public static extern AtkObjectHandle atk_get_focus_object();

	[DllImport(Libraries.Atk)]
	public static extern uint atk_add_key_event_listener(AtkKeySnoopFunc listener, IntPtr data);
	...
	[DllImport(Libraries.Atk)]
	public static extern AtkObjectHandle atk_get_root();

	[DllImport(Libraries.Atk)]
	public static extern void atk_focus_tracker_init(AtkEventListenerInit init);
	...
	[DllImport(Libraries.Atk)]
	public static extern uint atk_add_global_event_listener(GSignalEmissionHook listener, string event_type);
