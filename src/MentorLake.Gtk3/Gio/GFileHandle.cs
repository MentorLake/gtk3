...
public static class GFileHandleExtensions
{
	...
	{
		return GFileHandleExterns.g_file_append_to(file, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_append_to_finish(file, res);
	}
	...
	{
		return GFileHandleExterns.g_file_build_attribute_list_for_copy(file, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_copy(source, destination, flags, cancellable, progress_callback, progress_callback_data);
	}
	...
	{
		return GFileHandleExterns.g_file_copy_attributes(source, destination, flags, cancellable);
	}

	public static bool CopyFinish(this MentorLake.Gio.GFileHandle file, MentorLake.Gio.GAsyncResultHandle res)
	{
		return GFileHandleExterns.g_file_copy_finish(file, res);
	}
	...
	{
		return GFileHandleExterns.g_file_create(file, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_create_finish(file, res);
	}
	...
	{
		return GFileHandleExterns.g_file_create_readwrite(file, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_create_readwrite_finish(file, res);
	}

	public static bool Delete(this MentorLake.Gio.GFileHandle file, MentorLake.Gio.GCancellableHandle cancellable)
	{
		return GFileHandleExterns.g_file_delete(file, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_delete_finish(file, result);
	}
	...
	{
		return GFileHandleExterns.g_file_eject_mountable_finish(file, result);
	}
	...
	{
		return GFileHandleExterns.g_file_eject_mountable_with_operation_finish(file, result);
	}
	...
	{
		return GFileHandleExterns.g_file_enumerate_children(file, attributes, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_enumerate_children_finish(file, res);
	}
	...
	{
		return GFileHandleExterns.g_file_find_enclosing_mount(file, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_find_enclosing_mount_finish(file, res);
	}

	public static char GetBasename(this MentorLake.Gio.GFileHandle file)
	{
		return GFileHandleExterns.g_file_get_basename(file);
	}

	public static MentorLake.Gio.GFileHandle GetChild(this MentorLake.Gio.GFileHandle file, char name)
	{
	...
	{
		return GFileHandleExterns.g_file_get_child_for_display_name(file, display_name);
	}
	...
	public static char GetPath(this MentorLake.Gio.GFileHandle file)
	{
		return GFileHandleExterns.g_file_get_path(file);
	}

	public static char GetRelativePath(this MentorLake.Gio.GFileHandle parent, MentorLake.Gio.GFileHandle descendant)
	{
	...
	{
		return GFileHandleExterns.g_file_load_bytes(file, cancellable, out etag_out);
	}
	...
	{
		return GFileHandleExterns.g_file_load_bytes_finish(file, result, out etag_out);
	}
	...
	{
		return GFileHandleExterns.g_file_load_contents(file, cancellable, out contents, out length, out etag_out);
	}
	...
	{
		return GFileHandleExterns.g_file_load_contents_finish(file, res, out contents, out length, out etag_out);
	}
	...
	{
		return GFileHandleExterns.g_file_load_partial_contents_finish(file, res, out contents, out length, out etag_out);
	}

	public static bool MakeDirectory(this MentorLake.Gio.GFileHandle file, MentorLake.Gio.GCancellableHandle cancellable)
	{
		return GFileHandleExterns.g_file_make_directory(file, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_make_directory_finish(file, result);
	}
	...
	{
		return GFileHandleExterns.g_file_make_directory_with_parents(file, cancellable);
	}

	public static bool MakeSymbolicLink(this MentorLake.Gio.GFileHandle file, char symlink_value, MentorLake.Gio.GCancellableHandle cancellable)
	{
		return GFileHandleExterns.g_file_make_symbolic_link(file, symlink_value, cancellable);
	}

	public static T MakeSymbolicLinkAsync<T>(this T file, char symlink_value, int io_priority, MentorLake.Gio.GCancellableHandle cancellable, MentorLake.Gio.GAsyncReadyCallback callback, IntPtr user_data) where T : GFileHandle
	{
	...
	{
		return GFileHandleExterns.g_file_make_symbolic_link_finish(file, result);
	}
	...
	{
		return GFileHandleExterns.g_file_measure_disk_usage(file, flags, cancellable, progress_callback, progress_data, out disk_usage, out num_dirs, out num_files);
	}
	...
	{
		return GFileHandleExterns.g_file_measure_disk_usage_finish(file, result, out disk_usage, out num_dirs, out num_files);
	}
	...
	{
		return GFileHandleExterns.g_file_monitor(file, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_monitor_directory(file, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_monitor_file(file, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_mount_enclosing_volume_finish(location, result);
	}
	...
	{
		return GFileHandleExterns.g_file_mount_mountable_finish(file, result);
	}
	...
	{
		return GFileHandleExterns.g_file_move(source, destination, flags, cancellable, progress_callback, progress_callback_data);
	}
	...
	{
		return GFileHandleExterns.g_file_move_finish(file, result);
	}
	...
	{
		return GFileHandleExterns.g_file_open_readwrite(file, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_open_readwrite_finish(file, res);
	}

	public static char PeekPath(this MentorLake.Gio.GFileHandle file)
	{
	...
	{
		return GFileHandleExterns.g_file_poll_mountable_finish(file, result);
	}
	...
	{
		return GFileHandleExterns.g_file_query_default_handler(file, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_query_default_handler_finish(file, result);
	}
	...
	{
		return GFileHandleExterns.g_file_query_filesystem_info(file, attributes, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_query_filesystem_info_finish(file, res);
	}
	...
	{
		return GFileHandleExterns.g_file_query_info(file, attributes, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_query_info_finish(file, res);
	}
	...
	{
		return GFileHandleExterns.g_file_query_settable_attributes(file, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_query_writable_namespaces(file, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_read(file, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_read_finish(file, res);
	}
	...
	{
		return GFileHandleExterns.g_file_replace(file, etag, make_backup, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_replace_contents(file, contents, length, etag, make_backup, flags, out new_etag, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_replace_contents_finish(file, res, out new_etag);
	}
	...
	{
		return GFileHandleExterns.g_file_replace_finish(file, res);
	}
	...
	{
		return GFileHandleExterns.g_file_replace_readwrite(file, etag, make_backup, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_replace_readwrite_finish(file, res);
	}

	public static MentorLake.Gio.GFileHandle ResolveRelativePath(this MentorLake.Gio.GFileHandle file, char relative_path)
	{
	...
	{
		return GFileHandleExterns.g_file_set_attribute(file, attribute, type, value_p, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_set_attribute_byte_string(file, attribute, value, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_set_attribute_int32(file, attribute, value, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_set_attribute_int64(file, attribute, value, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_set_attribute_string(file, attribute, value, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_set_attribute_uint32(file, attribute, value, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_set_attribute_uint64(file, attribute, value, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_set_attributes_finish(file, result, out info);
	}
	...
	{
		return GFileHandleExterns.g_file_set_attributes_from_info(file, info, flags, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_set_display_name(file, display_name, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_set_display_name_finish(file, res);
	}
	...
	{
		return GFileHandleExterns.g_file_start_mountable_finish(file, result);
	}
	...
	{
		return GFileHandleExterns.g_file_stop_mountable_finish(file, result);
	}
	...
	{
		return GFileHandleExterns.g_file_trash(file, cancellable);
	}
	...
	{
		return GFileHandleExterns.g_file_trash_finish(file, result);
	}
	...
	{
		return GFileHandleExterns.g_file_unmount_mountable_finish(file, result);
	}
	...
	{
		return GFileHandleExterns.g_file_unmount_mountable_with_operation_finish(file, result);
	}

	public static MentorLake.Gio.GFileHandle NewBuildFilename(char first_element, IntPtr @__arglist)
	{
	...
	public static MentorLake.Gio.GFileHandle NewForCommandlineArg(char arg)
	{
		return GFileHandleExterns.g_file_new_for_commandline_arg(arg);
	}

	public static MentorLake.Gio.GFileHandle NewForCommandlineArgAndCwd(char arg, char cwd)
	{
		return GFileHandleExterns.g_file_new_for_commandline_arg_and_cwd(arg, cwd);
	}

	public static MentorLake.Gio.GFileHandle NewForPath(char path)
	{
	...
	public static MentorLake.Gio.GFileHandle NewTmp(char tmpl, out MentorLake.Gio.GFileIOStreamHandle iostream)
	{
		return GFileHandleExterns.g_file_new_tmp(tmpl, out iostream);
	}

	public static void NewTmpAsync(char tmpl, int io_priority, MentorLake.Gio.GCancellableHandle cancellable, MentorLake.Gio.GAsyncReadyCallback callback, IntPtr user_data)
	{
		GFileHandleExterns.g_file_new_tmp_async(tmpl, io_priority, cancellable, callback, user_data);
	}

	public static void NewTmpDirAsync(char tmpl, int io_priority, MentorLake.Gio.GCancellableHandle cancellable, MentorLake.Gio.GAsyncReadyCallback callback, IntPtr user_data)
	{
	...
	{
		return GFileHandleExterns.g_file_new_tmp_dir_finish(result);
	}
	...
	{
		return GFileHandleExterns.g_file_new_tmp_finish(result, out iostream);
	}
...
internal class GFileHandleExterns
{
	...
	[DllImport(GioLibrary.Name)]
	internal static extern char g_file_get_basename([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GFileHandleImpl>))] MentorLake.Gio.GFileHandle file);

	[DllImport(GioLibrary.Name)]
	internal static extern MentorLake.Gio.GFileHandle g_file_get_child([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GFileHandleImpl>))] MentorLake.Gio.GFileHandle file, char name);

	[DllImport(GioLibrary.Name)]
	internal static extern MentorLake.Gio.GFileHandle g_file_get_child_for_display_name([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GFileHandleImpl>))] MentorLake.Gio.GFileHandle file, string display_name);
	...
	[DllImport(GioLibrary.Name)]
	internal static extern char g_file_get_path([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GFileHandleImpl>))] MentorLake.Gio.GFileHandle file);

	[DllImport(GioLibrary.Name)]
	internal static extern char g_file_get_relative_path([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GFileHandleImpl>))] MentorLake.Gio.GFileHandle parent, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GFileHandleImpl>))] MentorLake.Gio.GFileHandle descendant);
	...
	[DllImport(GioLibrary.Name)]
	internal static extern bool g_file_measure_disk_usage_finish([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GFileHandleImpl>))] MentorLake.Gio.GFileHandle file, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GAsyncResultHandleImpl>))] MentorLake.Gio.GAsyncResultHandle result, out ulong disk_usage, out ulong num_dirs, out ulong num_files);
	...
	[DllImport(GioLibrary.Name)]
	internal static extern char g_file_peek_path([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GFileHandleImpl>))] MentorLake.Gio.GFileHandle file);
	...
	[DllImport(GioLibrary.Name)]
	internal static extern bool g_file_replace_contents_finish([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GFileHandleImpl>))] MentorLake.Gio.GFileHandle file, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GAsyncResultHandleImpl>))] MentorLake.Gio.GAsyncResultHandle res, out string new_etag);
	...
	[DllImport(GioLibrary.Name)]
	internal static extern MentorLake.Gio.GFileHandle g_file_resolve_relative_path([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GFileHandleImpl>))] MentorLake.Gio.GFileHandle file, char relative_path);
	...
	[DllImport(GioLibrary.Name)]
	internal static extern MentorLake.Gio.GFileHandle g_file_new_build_filename(char first_element, IntPtr @__arglist);
