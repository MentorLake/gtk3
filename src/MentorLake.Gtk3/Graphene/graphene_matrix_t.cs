...
public static class graphene_matrix_tExtensions
{
	...
	{
		if (m.IsInvalid || m.IsClosed) throw new Exception("Invalid or closed handle (graphene_matrix_t)");
	...
	{
		if (a.IsInvalid || a.IsClosed) throw new Exception("Invalid or closed handle (graphene_matrix_t)");
	...
	{
		if (projection.IsInvalid || projection.IsClosed) throw new Exception("Invalid or closed handle (graphene_matrix_t)");
