...
public class GtkRangeAccessibleHandle : GtkWidgetAccessibleHandle, AtkComponentHandle, AtkValueHandle
{
}
public static class GtkRangeAccessibleHandleSignalExtensions
{
/// <summary>
/// <para>
...
/// </summary>
	...
	public static IObservable<GtkRangeAccessibleHandleSignalStructs.BoundsChangedSignal> Signal_BoundsChanged(this GtkRangeAccessibleHandle instance, GConnectFlags connectFlags = GConnectFlags.G_CONNECT_AFTER)
	{
		return Observable.Create((IObserver<GtkRangeAccessibleHandleSignalStructs.BoundsChangedSignal> obs) =>
		{
			GtkRangeAccessibleHandleSignalDelegates.bounds_changed handler = ( MentorLake.Atk.AtkComponentHandle self,  MentorLake.Atk.AtkRectangleHandle arg1,  IntPtr user_data) =>
			{
				

				var signalStruct = new GtkRangeAccessibleHandleSignalStructs.BoundsChangedSignal()
				{
...
/// </summary>
	...
	public static IObservable<GtkRangeAccessibleHandleSignalStructs.ValueChangedSignal> Signal_ValueChanged(this GtkRangeAccessibleHandle instance, GConnectFlags connectFlags = GConnectFlags.G_CONNECT_AFTER)
	{
		return Observable.Create((IObserver<GtkRangeAccessibleHandleSignalStructs.ValueChangedSignal> obs) =>
		{
			GtkRangeAccessibleHandleSignalDelegates.value_changed handler = ( MentorLake.Atk.AtkValueHandle self,  double value,  string text,  IntPtr user_data) =>
			{
				

				var signalStruct = new GtkRangeAccessibleHandleSignalStructs.ValueChangedSignal()
				{
...
public static class GtkRangeAccessibleHandleSignalStructs
{
...
public static class GtkRangeAccessibleHandleSignalDelegates
{
...
public static class GtkRangeAccessibleHandleExtensions
{
}

internal class GtkRangeAccessibleHandleExterns
{
}
