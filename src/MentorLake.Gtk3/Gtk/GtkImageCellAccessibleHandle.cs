...
public static class GtkImageCellAccessibleHandleSignalExtensions
{
/// <summary>
/// <para>
...
/// </summary>
	...
	public static IObservable<GtkImageCellAccessibleHandleSignalStructs.BoundsChangedSignal> Signal_BoundsChanged(this GtkImageCellAccessibleHandle instance, GConnectFlags connectFlags = GConnectFlags.G_CONNECT_AFTER)
	{
		return Observable.Create((IObserver<GtkImageCellAccessibleHandleSignalStructs.BoundsChangedSignal> obs) =>
		{
			GtkImageCellAccessibleHandleSignalDelegates.bounds_changed handler = ( MentorLake.Atk.AtkComponentHandle self,  MentorLake.Atk.AtkRectangleHandle arg1,  IntPtr user_data) =>
			{
				

				var signalStruct = new GtkImageCellAccessibleHandleSignalStructs.BoundsChangedSignal()
				{
...
public static class GtkImageCellAccessibleHandleSignalStructs
{
...
public static class GtkImageCellAccessibleHandleSignalDelegates
{
