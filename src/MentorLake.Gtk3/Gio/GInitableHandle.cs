...
{
	public static bool Init(this MentorLake.Gio.GInitableHandle initable, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GInitableHandleExterns.g_initable_init(initable, cancellable, error);
	}
	...
	public static MentorLake.GObject.GObjectHandle NewValist(MentorLake.GObject.GType object_type, string first_property_name, IntPtr var_args, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GInitableHandleExterns.g_initable_new_valist(object_type, first_property_name, var_args, cancellable, error);
	}

	public static MentorLake.GObject.GObjectHandle Newv(MentorLake.GObject.GType object_type, uint n_parameters, MentorLake.GObject.GParameter[] parameters, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GInitableHandleExterns.g_initable_newv(object_type, n_parameters, parameters, cancellable, error);
	}
