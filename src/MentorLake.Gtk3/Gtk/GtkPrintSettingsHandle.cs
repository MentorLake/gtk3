...
public static class GtkPrintSettingsHandleExtensions
{
	...
	{
		if (other.IsInvalid || other.IsClosed) throw new Exception("Invalid or closed handle (GtkPrintSettingsHandle)");
	...
	{
		if (settings.IsInvalid || settings.IsClosed) throw new Exception("Invalid or closed handle (GtkPrintSettingsHandle)");
