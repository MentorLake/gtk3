...
{
	public static GtkGestureDragHandle New(GtkWidgetHandle widget)
	{
		return GtkGestureDragExterns.gtk_gesture_drag_new(widget);
	}
...
internal class GtkGestureDragExterns
{
	...
	internal static extern GtkGestureDragHandle gtk_gesture_drag_new(GtkWidgetHandle widget);
