...
public static class GFileOutputStreamHandleExtensions
{
	...
	public static MentorLake.Gio.GFileInfoHandle QueryInfo(this MentorLake.Gio.GFileOutputStreamHandle stream, string attributes, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GFileOutputStreamHandleExterns.g_file_output_stream_query_info(stream, attributes, cancellable, error);
	}
	...
	public static MentorLake.Gio.GFileInfoHandle QueryInfoFinish(this MentorLake.Gio.GFileOutputStreamHandle stream, MentorLake.Gio.GAsyncResultHandle result, IntPtr error)
	{
		return GFileOutputStreamHandleExterns.g_file_output_stream_query_info_finish(stream, result, error);
	}
