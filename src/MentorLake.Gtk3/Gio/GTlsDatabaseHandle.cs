...
public static class GTlsDatabaseHandleExtensions
{
	...
	public static MentorLake.Gio.GTlsCertificateHandle LookupCertificateForHandle(this MentorLake.Gio.GTlsDatabaseHandle self, string handle, MentorLake.Gio.GTlsInteractionHandle interaction, MentorLake.Gio.GTlsDatabaseLookupFlags flags, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GTlsDatabaseHandleExterns.g_tls_database_lookup_certificate_for_handle(self, handle, interaction, flags, cancellable, error);
	}
	...
	public static MentorLake.Gio.GTlsCertificateHandle LookupCertificateForHandleFinish(this MentorLake.Gio.GTlsDatabaseHandle self, MentorLake.Gio.GAsyncResultHandle result, IntPtr error)
	{
		return GTlsDatabaseHandleExterns.g_tls_database_lookup_certificate_for_handle_finish(self, result, error);
	}

	public static MentorLake.Gio.GTlsCertificateHandle LookupCertificateIssuer(this MentorLake.Gio.GTlsDatabaseHandle self, MentorLake.Gio.GTlsCertificateHandle certificate, MentorLake.Gio.GTlsInteractionHandle interaction, MentorLake.Gio.GTlsDatabaseLookupFlags flags, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GTlsDatabaseHandleExterns.g_tls_database_lookup_certificate_issuer(self, certificate, interaction, flags, cancellable, error);
	}
	...
	public static MentorLake.Gio.GTlsCertificateHandle LookupCertificateIssuerFinish(this MentorLake.Gio.GTlsDatabaseHandle self, MentorLake.Gio.GAsyncResultHandle result, IntPtr error)
	{
		return GTlsDatabaseHandleExterns.g_tls_database_lookup_certificate_issuer_finish(self, result, error);
	}

	public static MentorLake.GLib.GListHandle LookupCertificatesIssuedBy(this MentorLake.Gio.GTlsDatabaseHandle self, MentorLake.GLib.GByteArrayHandle issuer_raw_dn, MentorLake.Gio.GTlsInteractionHandle interaction, MentorLake.Gio.GTlsDatabaseLookupFlags flags, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GTlsDatabaseHandleExterns.g_tls_database_lookup_certificates_issued_by(self, issuer_raw_dn, interaction, flags, cancellable, error);
	}
	...
	public static MentorLake.GLib.GListHandle LookupCertificatesIssuedByFinish(this MentorLake.Gio.GTlsDatabaseHandle self, MentorLake.Gio.GAsyncResultHandle result, IntPtr error)
	{
		return GTlsDatabaseHandleExterns.g_tls_database_lookup_certificates_issued_by_finish(self, result, error);
	}

	public static MentorLake.Gio.GTlsCertificateFlags VerifyChain(this MentorLake.Gio.GTlsDatabaseHandle self, MentorLake.Gio.GTlsCertificateHandle chain, string purpose, MentorLake.Gio.GSocketConnectableHandle identity, MentorLake.Gio.GTlsInteractionHandle interaction, MentorLake.Gio.GTlsDatabaseVerifyFlags flags, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GTlsDatabaseHandleExterns.g_tls_database_verify_chain(self, chain, purpose, identity, interaction, flags, cancellable, error);
	}
	...
	public static MentorLake.Gio.GTlsCertificateFlags VerifyChainFinish(this MentorLake.Gio.GTlsDatabaseHandle self, MentorLake.Gio.GAsyncResultHandle result, IntPtr error)
	{
		return GTlsDatabaseHandleExterns.g_tls_database_verify_chain_finish(self, result, error);
	}
