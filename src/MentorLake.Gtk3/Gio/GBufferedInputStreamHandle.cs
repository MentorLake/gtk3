...
{
	public static UIntPtr Fill(this MentorLake.Gio.GBufferedInputStreamHandle stream, UIntPtr count, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GBufferedInputStreamHandleExterns.g_buffered_input_stream_fill(stream, count, cancellable, error);
	}
	...
	public static UIntPtr FillFinish(this MentorLake.Gio.GBufferedInputStreamHandle stream, MentorLake.Gio.GAsyncResultHandle result, IntPtr error)
	{
		return GBufferedInputStreamHandleExterns.g_buffered_input_stream_fill_finish(stream, result, error);
	}
	...
	public static int ReadByte(this MentorLake.Gio.GBufferedInputStreamHandle stream, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GBufferedInputStreamHandleExterns.g_buffered_input_stream_read_byte(stream, cancellable, error);
	}
