...
public static class graphene_quaternion_tExtensions
{
	...
	{
		if (a.IsInvalid || a.IsClosed) throw new Exception("Invalid or closed handle (graphene_quaternion_t)");
	...
	{
		if (q.IsInvalid || q.IsClosed) throw new Exception("Invalid or closed handle (graphene_quaternion_t)");
