...
public static class GUnixConnectionHandleExtensions
{
	...
	{
		return GUnixConnectionHandleExterns.g_unix_connection_receive_credentials(connection, cancellable);
	}
	...
	{
		return GUnixConnectionHandleExterns.g_unix_connection_receive_credentials_finish(connection, result);
	}
	...
	{
		return GUnixConnectionHandleExterns.g_unix_connection_receive_fd(connection, cancellable);
	}
	...
	{
		return GUnixConnectionHandleExterns.g_unix_connection_send_credentials(connection, cancellable);
	}
	...
	{
		return GUnixConnectionHandleExterns.g_unix_connection_send_credentials_finish(connection, result);
	}
	...
	{
		return GUnixConnectionHandleExterns.g_unix_connection_send_fd(connection, fd, cancellable);
	}
