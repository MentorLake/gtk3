...
public static class GProxyResolverHandleExtensions
{
	...
	public static string[] Lookup(this MentorLake.Gio.GProxyResolverHandle resolver, string uri, MentorLake.Gio.GCancellableHandle cancellable, IntPtr error)
	{
		return GProxyResolverHandleExterns.g_proxy_resolver_lookup(resolver, uri, cancellable, error);
	}
	...
	public static string[] LookupFinish(this MentorLake.Gio.GProxyResolverHandle resolver, MentorLake.Gio.GAsyncResultHandle result, IntPtr error)
	{
		return GProxyResolverHandleExterns.g_proxy_resolver_lookup_finish(resolver, result, error);
	}
