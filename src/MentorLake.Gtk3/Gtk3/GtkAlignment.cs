...
{
	public static GtkAlignmentHandle GetPadding(this GtkAlignmentHandle alignment, out uint padding_top, out uint padding_bottom, out uint padding_left, out uint padding_right)
	{
	...
	public static GtkAlignmentHandle Set(this GtkAlignmentHandle alignment, float xalign, float yalign, float xscale, float yscale)
	{
		GtkAlignmentExterns.gtk_alignment_set(alignment, xalign, yalign, xscale, yscale);
		return alignment;
	}

	public static GtkAlignmentHandle SetPadding(this GtkAlignmentHandle alignment, uint padding_top, uint padding_bottom, uint padding_left, uint padding_right)
	{
