...
public class GIOStreamHandle : GObjectHandle
{
	...
	{
		return GIOStreamHandleExterns.g_io_stream_splice_finish(result);
	}
...
public static class GIOStreamHandleExtensions
{
	...
	{
		return GIOStreamHandleExterns.g_io_stream_close(stream, cancellable);
	}
	...
	{
		return GIOStreamHandleExterns.g_io_stream_close_finish(stream, result);
	}
	...
	{
		return GIOStreamHandleExterns.g_io_stream_set_pending(stream);
	}
...
internal class GIOStreamHandleExterns
{
	...
	[DllImport(GioLibrary.Name)]
	internal static extern bool g_io_stream_set_pending([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GIOStreamHandle>))] MentorLake.Gio.GIOStreamHandle stream);
	...
	[DllImport(GioLibrary.Name)]
	internal static extern bool g_io_stream_splice_finish([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GAsyncResultHandleImpl>))] MentorLake.Gio.GAsyncResultHandle result);
