...
public static class GObjectHandleExtensions
{
	...
	{
		if (@object.IsInvalid || @object.IsClosed) throw new Exception("Invalid or closed handle (GObjectHandle)");
	...
	{
		if (source.IsInvalid || source.IsClosed) throw new Exception("Invalid or closed handle (GObjectHandle)");
