...
public static class GDBusMessageHandleExtensions
{
	...
	{
		if (message.IsInvalid || message.IsClosed) throw new Exception("Invalid or closed handle (GDBusMessageHandle)");
	...
	{
		if (method_call_message.IsInvalid || method_call_message.IsClosed) throw new Exception("Invalid or closed handle (GDBusMessageHandle)");
