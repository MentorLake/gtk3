...
public class GdkPixbufHandle : GObjectHandle, GIconHandle, GLoadableIconHandle
{
	...
	public static MentorLake.GdkPixbuf.GdkPixbufHandle NewFromFile(char filename)
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_new_from_file(filename);
	}

	public static MentorLake.GdkPixbuf.GdkPixbufHandle NewFromFileAtScale(char filename, int width, int height, bool preserve_aspect_ratio)
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_new_from_file_at_scale(filename, width, height, preserve_aspect_ratio);
	}

	public static MentorLake.GdkPixbuf.GdkPixbufHandle NewFromFileAtSize(char filename, int width, int height)
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_new_from_file_at_size(filename, width, height);
	}

	public static MentorLake.GdkPixbuf.GdkPixbufHandle NewFromInline(int data_length, byte[] data, bool copy_pixels)
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_new_from_inline(data_length, data, copy_pixels);
	}

	public static MentorLake.GdkPixbuf.GdkPixbufHandle NewFromResource(string resource_path)
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_new_from_resource(resource_path);
	}
	...
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_new_from_resource_at_scale(resource_path, width, height, preserve_aspect_ratio);
	}
	...
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_new_from_stream(stream, cancellable);
	}
	...
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_new_from_stream_at_scale(stream, width, height, preserve_aspect_ratio, cancellable);
	}

	public static MentorLake.GdkPixbuf.GdkPixbufHandle NewFromStreamFinish(MentorLake.Gio.GAsyncResultHandle async_result)
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_new_from_stream_finish(async_result);
	}
	...
	public static MentorLake.GdkPixbuf.GdkPixbufFormatHandle GetFileInfo(char filename, out int width, out int height)
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_get_file_info(filename, out width, out height);
	}

	public static void GetFileInfoAsync(char filename, MentorLake.Gio.GCancellableHandle cancellable, MentorLake.Gio.GAsyncReadyCallback callback, IntPtr user_data)
	{
	...
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_get_file_info_finish(async_result, out width, out height);
	}
	...
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_init_modules(path);
	}
	...
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_save_to_stream_finish(async_result);
	}
...
public static class GdkPixbufHandleExtensions
{
	...
	public static bool Save(this MentorLake.GdkPixbuf.GdkPixbufHandle pixbuf, char filename, string type, IntPtr error, IntPtr @__arglist)
	{
	...
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_save_to_bufferv(pixbuf, out buffer, out buffer_size, type, option_keys, option_values);
	}
	...
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_save_to_callbackv(pixbuf, save_func, user_data, type, option_keys, option_values);
	}
	...
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_save_to_streamv(pixbuf, stream, type, option_keys, option_values, cancellable);
	}
	...
	public static bool Savev(this MentorLake.GdkPixbuf.GdkPixbufHandle pixbuf, char filename, string type, string[] option_keys, string[] option_values)
	{
		return GdkPixbufHandleExterns.gdk_pixbuf_savev(pixbuf, filename, type, option_keys, option_values);
	}
...
internal class GdkPixbufHandleExterns
{
	...
	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern MentorLake.GdkPixbuf.GdkPixbufHandle gdk_pixbuf_new_from_file(char filename);

	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern MentorLake.GdkPixbuf.GdkPixbufHandle gdk_pixbuf_new_from_file_at_scale(char filename, int width, int height, bool preserve_aspect_ratio);

	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern MentorLake.GdkPixbuf.GdkPixbufHandle gdk_pixbuf_new_from_file_at_size(char filename, int width, int height);

	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern MentorLake.GdkPixbuf.GdkPixbufHandle gdk_pixbuf_new_from_inline(int data_length, byte[] data, bool copy_pixels);

	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern MentorLake.GdkPixbuf.GdkPixbufHandle gdk_pixbuf_new_from_resource(string resource_path);

	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern MentorLake.GdkPixbuf.GdkPixbufHandle gdk_pixbuf_new_from_resource_at_scale(string resource_path, int width, int height, bool preserve_aspect_ratio);
	...
	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern MentorLake.GdkPixbuf.GdkPixbufHandle gdk_pixbuf_new_from_stream_finish([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GAsyncResultHandleImpl>))] MentorLake.Gio.GAsyncResultHandle async_result);
	...
	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern bool gdk_pixbuf_save([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.GdkPixbuf.GdkPixbufHandle>))] MentorLake.GdkPixbuf.GdkPixbufHandle pixbuf, char filename, string type, IntPtr error, IntPtr @__arglist);
	...
	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern bool gdk_pixbuf_savev([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.GdkPixbuf.GdkPixbufHandle>))] MentorLake.GdkPixbuf.GdkPixbufHandle pixbuf, char filename, string type, string[] option_keys, string[] option_values);
	...
	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern MentorLake.GdkPixbuf.GdkPixbufFormatHandle gdk_pixbuf_get_file_info(char filename, out int width, out int height);

	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern void gdk_pixbuf_get_file_info_async(char filename, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GCancellableHandle>))] MentorLake.Gio.GCancellableHandle cancellable, MentorLake.Gio.GAsyncReadyCallback callback, IntPtr user_data);

	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern MentorLake.GdkPixbuf.GdkPixbufFormatHandle gdk_pixbuf_get_file_info_finish([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GAsyncResultHandleImpl>))] MentorLake.Gio.GAsyncResultHandle async_result, out int width, out int height);

	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern MentorLake.GLib.GSListHandle gdk_pixbuf_get_formats();

	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern bool gdk_pixbuf_init_modules(string path);
	...
	[DllImport(GdkPixbufLibrary.Name)]
	internal static extern bool gdk_pixbuf_save_to_stream_finish([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DelegateSafeHandleMarshaller<MentorLake.Gio.GAsyncResultHandleImpl>))] MentorLake.Gio.GAsyncResultHandle async_result);
